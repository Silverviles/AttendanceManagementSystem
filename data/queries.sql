...
CREATE TABLE IF NOT EXISTS classes (
    ...
    module_code VARCHAR(8) NOT NULL UNIQUE,
    batch CHAR(8) NOT NULL,
    FOREIGN KEY (module_code) REFERENCES module(module_code)
);

INSERT INTO classes (duration,locations, module_code,batch) VALUES
('8.00am-10.00am', 'FF2', 'Project Management', '2026A'),
('11.00am-1.00pm', 'Mentoring', 'Technology Challenge Competition 1', '2026A');
